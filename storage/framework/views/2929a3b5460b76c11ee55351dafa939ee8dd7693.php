      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="#">
            ...
            <div class="form-group">
              <!-- <label for="appointment_email" class="text-black">Email</label> -->
              <input type="text" class="form-control" id="contact_number" placeholder="contactnumber">
            </div>
...
</html><?php /**PATH D:\xampp\htdocs\laravel\hospital\resources\views/welcome.blade.php ENDPATH**/ ?>